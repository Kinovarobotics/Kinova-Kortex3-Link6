...
# This function computes the forward kinematics and prints the output
def example_forward_kinematics(base):
    ...
    print(
        "Theta (theta_x, theta_y, theta_z)  : ({}, {}, {})".format(
...
# This function computes the inverse kinematics and prints the output
